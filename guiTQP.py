...
class Questions:
    ...
    def get_option(self):
        options = [[city[0].natural, city[2].natural, city[4].natural, city[9].natural], [city[0].food, city[1].food, city[2].food, city[3].food, city[4].food, city[5].food, city[6].food, city[7].food, city[8].food, city[9].food], [city[0].dress, city[1].dress, city[2].dress, city[3].dress, city[4].dress, city[5].dress, city[6].dress, city[7].dress, city[8].dress, city[9].dress], [city[0].intent, city[2].intent, city[5].intent, city[9].intent], ]
...
ques = []
ques.append(Questions(q[0]))
ques.append(Questions(q[1]))
ques.append(Questions(q[2]))
ques.append(Questions(q[3]))
for k in range(0,len(ques)):
    ans = ques[k].get_option()
